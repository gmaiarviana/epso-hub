...
Hoje o repositório está em reestruturação em blocos — a pessoa (filosofia, estudo, contexto) e a instituição (o EPSO); estrutura-alvo e etapas no [next-steps da raiz](next-steps.md). O mapa detalhado de cada frente entra no momento em que ela for migrada.
