...
A estrutura `fontes/destilados/` já existe à frente; a sessão dedicada decide com ela
...
- **Processo de encerramento de chat** — o gêmeo do `processo-transcricoes.md` para
  ...
  aberta: o destilado sai na voz recomposta (ideia reescrita em 1ª pessoa) ou colado ao
  que o incorporador digitou.
- **Reconciliar a camada limpa** — o modelo áudio → bruto → limpo das transcrições (já
  tratado em `processo-transcricoes.md`) reconciliado com esta estrutura, para não
  conflitar.
